...
namespace DA3.Web.App_Start
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(FasFoodDbcontext.Create);
        ...
        public class AuthorizationServerProvider : OAuthAuthorizationServerProvider
        {
            ...
            public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
            {
                ...
                {
                    context.SetError("Tài khoản hoặc mật khẩu không đúng.", "Tài khoản hoặc mật khẩu không đúng.");
                    context.Rejected();
                }
            }
        }
        ...
        {
            var userStore = new UserStore<ApplicationUser>(context.Get<FasFoodDbcontext>());
